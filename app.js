        ...
        items: [
            {
                ...
                a: {
                    ru: `Тебе нужно запустить бота и нажать на “ПОЛУЧИТЬ СИГНАЛ”, пройти регистрацию и пополнить аккаунт на любую сумму.</p>`,
                    en: `You need to launch the bot and click on “GET SIGNAL”, register, and top up your account with any amount.</p>`
                }
            },
            {
                id: "have-account",
